...
| 已审查服务器提交 | `5a3bcdf5fbc75574938dc35acf48b12145b37582` |
| Python SDK | [`arena-hero/arena-hero-python`](https://github.com/arena-hero/arena-hero-python)，v0.2.6 |
| 已审查 SDK 提交 | `4a295851002ac5e73b34fa652e8d084f780c01ed` |
...
公开 API 仍是 v0.1，当前游戏规则是 v0.10，所以站点只发布一个当前版本，提供英文和简体
