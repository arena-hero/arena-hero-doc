...
[complete Arena Hero v0.8 gameplay contract](https://github.com/arena-hero/arena-hero-skill/blob/main/references/game-rules.md).
...
stacking behavior. If the live contract is newer than the bundled v0.8 rules, it
